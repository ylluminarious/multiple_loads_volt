...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'multiple-loads-volt.com'
  config.app_name = 'Multiple_loads_volt'
  config.mailer.from = 'Multiple_loads_volt <no-reply@multiple-loads-volt.com>'
  ...
  #
  config.app_secret = 'VQRNuYTHIG2qgRT-1cFlgiDps6i67ActOG5Ay6uHAtsqQy_ixIUZKY4GXiNSxfKvZao'
